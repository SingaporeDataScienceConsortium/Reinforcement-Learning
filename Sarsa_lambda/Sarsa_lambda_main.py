...
from Sarsa_lambda_env import Maze
from Sarsa_lambda_brain import SarsaLambdaTable
...
def update():
    for game in range(100): # 100 rounds
        ...
        # initial all zero eligibility trace (UNIQUE feature of lambda maze)
        ...
        while True:
            ...
            # RL choose action based on next curr_position
...
if __name__ == "__main__":
    ...
    RL = SarsaLambdaTable(actions=list(range(env.n_actions))) # input: [0,1,2,3] -> a list
